 ...
 * KitchenChecklist. Items grouped by section with big tap targets,
 * per-section + overall progress, and a Manager Sign-Off that locks the
 * run once complete. Sign-off enabled for owner_admin and kitchen roles.
 */
